...
from manapathi import models, api, _
from manapathi.tools import float_compare
...
class ResCurrencyRate(models.Model):
    ...
    def _onchange_rate_warning(self):
        # We send the ETA a rate that is 5 decimal accuracy, so to ensure consistency, Manapathi should also operate with 5 decimal accuracy rate
        if (
