...
from manapathi.fields import Date, Datetime
from manapathi.tools import float_is_zero, mute_logger
from manapathi.tests import Form, tagged
from manapathi.addons.account.tests.common import AccountTestInvoicingCommon
from manapathi.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
...
class TestAngloSaxonValuationPurchaseMRP(AccountTestInvoicingCommon):
    ...
    def test_buy_deliver_and_return_kit_with_auto_avco_components(self):
        ...
        with mute_logger('manapathi.tests.form.onchange'):
