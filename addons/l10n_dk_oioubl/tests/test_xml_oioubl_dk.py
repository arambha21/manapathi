...
from manapathi.addons.l10n_account_edi_ubl_cii_tests.tests.common import TestUBLCommon
from manapathi.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
from manapathi.exceptions import UserError
from manapathi.tests import tagged
from manapathi.tools import file_open
...
class TestUBLDK(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def test_export_invoice_two_line_partner_dk(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_manapathi/oioubl_out_invoice_partner_dk.xml")
    ...
    def test_export_invoice_two_line_foreign_partner_be(self):
        ...
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_manapathi/oioubl_out_invoice_foreign_partner_be.xml")

    @freeze_time('2017-01-01')
    def test_export_invoice_two_line_foreign_partner_fr(self):
        invoice = self.create_post_and_send_invoice(partner=self.partner_c)
        self.assertTrue(invoice.ubl_cii_xml_id)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, xpaths=None, expected_file_path="from_manapathi/oioubl_out_invoice_foreign_partner_fr.xml")
    ...
    def test_export_credit_note_two_line_partner_dk(self):
        ...
        self._assert_invoice_attachment(refund.ubl_cii_xml_id, xpaths=None, expected_file_path="from_manapathi/oioubl_out_refund_partner_dk.xml")
    ...
    def test_export_credit_note_two_line_partner_fr(self):
        ...
        self.assertTrue(refund.ubl_cii_xml_id)
        self._assert_invoice_attachment(refund.ubl_cii_xml_id, xpaths=None, expected_file_path="from_manapathi/oioubl_out_refund_foreign_partner_fr.xml")
