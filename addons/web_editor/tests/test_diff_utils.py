...
from manapathi.tests.common import BaseCase
from manapathi.addons.web_editor.models.diff_utils import (
    generate_patch,
    generate_comparison,
    apply_patch,
)
...
@manapathi.tests.tagged("post_install", "-at_install", "html_history")
