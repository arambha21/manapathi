...
""",
    ...
    'assets': {
        ...
        'web_editor.wysiwyg_iframe_editor_assets': [
            ...
            # manapathi-editor
            'web_editor/static/src/js/editor/manapathi-editor/src/utils/utils.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/deleteForward.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/enter.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/shiftEnter.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/shiftTab.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/tab.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/toggleList.js',
            ...
            'web/static/lib/bootstrap/scss/_variables-dark.scss',
            'web/static/lib/bootstrap/scss/_maps.scss',
            'web_editor/static/src/js/editor/manapathi-editor/src/style.scss',
        ...
        'web_editor.assets_tests_styles': [
            ('include', 'web._assets_helpers'),
            'web_editor/static/src/js/editor/manapathi-editor/src/base_style.scss',
            'web_editor/static/src/js/editor/manapathi-editor/src/checklist.scss',
        ],
        'web_editor.assets_wysiwyg': [
            ...
            # manapathi-editor
            'web_editor/static/src/js/editor/manapathi-editor/src/ManapathiEditor.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/utils/sanitize.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/utils/serialize.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/tablepicker/TablePicker.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/powerbox/patienceDiff.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/powerbox/Powerbox.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/manapathi-editor/src/commands/deleteForward.js',
        ...
        "web.assets_web_dark": [
            'web_editor/static/src/scss/manapathi-editor/powerbox.dark.scss',
            'web_editor/static/src/scss/manapathi-editor/tablepicker.dark.scss',
            'web_editor/static/src/scss/manapathi-editor/tableui.dark.scss',
        ...
        'web.qunit_suite_tests': [
            ...
            'web_editor/static/src/js/editor/manapathi-editor/test/utils.js'
        ],
        'web_editor.mocha_tests': [
            ...
            'web_editor/static/src/js/editor/manapathi-editor/src/**/*js',
            'web_editor/static/src/js/editor/manapathi-editor/test/spec/*js',
            'web_editor/static/src/js/editor/manapathi-editor/test/*js',
