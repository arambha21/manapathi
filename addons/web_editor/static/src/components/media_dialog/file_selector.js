...
import { Component, xml, useState, useRef, onWillStart, useEffect } from "@manapathi/owl";
        ...
        <Dialog title="title">
            <div class="form-text">
                ...
                <ul t-foreach="props.views"  t-as="view" t-key="view.id">
                    <li>
                        <a t-att-href="'/manapathi/ir.ui.view/' + window.encodeURIComponent(view.id)">
                            <t t-esc="view.name"/>
                        </a>
                    </li>
                </ul>
...
export class FileSelector extends Component {
    ...
    async fetchAttachments(limit, offset) {
        ...
        try {
            ...
            if (e.exceptionName !== 'manapathi.exceptions.AccessError') {
                throw e;
            }
        }
