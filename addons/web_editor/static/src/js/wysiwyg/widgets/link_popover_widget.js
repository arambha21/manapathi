...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.manapathiEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start(); // This is not async
        params.wysiwyg?.manapathiEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        if (document !== this.wysiwyg.manapathiEditor.document) {
            $(this.wysiwyg.manapathiEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.manapathiEditor.document).off('.link_popover');
