...
import { useState, useEffect, useRef } from "@manapathi/owl";
...
export class ChatGPTPromptDialog extends ChatGPTDialog {
    ...
    setup() {
        super.setup();
        this.assistantAvatarUrl = `${browser.location.origin}/web_editor/static/src/img/manapathibot_transparent.png`;
