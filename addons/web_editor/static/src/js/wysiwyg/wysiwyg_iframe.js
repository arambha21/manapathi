...
import { useEffect } from "@manapathi/owl";
...
patch(Wysiwyg.prototype, {
    ...
    _loadIframe() {
        var self = this;
        this.$editable = $('<div class="note-editable oe_structure manapathi-editor-editable"></div>');
        this.$el.removeClass('note-editable oe_structure manapathi-editor-editable');
        ...
        var def = new Promise(function (resolve) {
            window.top[self._onUpdateIframeId] = function (_avoidDoubleLoad) {
                ...
                const $iframeWrapper = $('<div class="iframe-editor-wrapper manapathi-editor">');
...
function getWysiwygIframeContent(params) {
    ...
    return `
        ...
        <script type="text/javascript">
            window.manapathi?.define('root.widget', ['@web/legacy/js/public/public_widget'], function (require) {
                'use strict';
    ...
    <body class="o_in_iframe">
        ...
        <script type="text/javascript">
            window.manapathi?.define('web_editor.wysiwyg.iniframe', [], function (require) {
                'use strict';
