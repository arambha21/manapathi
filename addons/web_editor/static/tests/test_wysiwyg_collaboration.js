...
import {
    ...
    patchEditorIframe,
} from '@web_editor/js/editor/manapathi-editor/test/utils';
...
class PeerTest {
    ...
    async startEditor() {
        ...
        if (this.initialParsedSelection) {
            ...
            this.wysiwyg.manapathiEditor._recordHistorySelection();
        } else {
    ...
    async getValue() {
        this.wysiwyg.manapathiEditor.observerUnactive('PeerTest.getValue');
        renderTextualSelection(this.wysiwyg.manapathiEditor);
        ...
        this.wysiwyg.manapathiEditor.observerActive('PeerTest.getValue');
...
export async function createPeers(peers) {
    ...
    for (const peerId of peers) {
        ...
        patch(wysiwyg, {
            ...
            // Hacky hook as we know this method is called after setting the value in the wysiwyg start and before sending the value to manapathiEditor.
    ...
    QUnit.module('Collaboration', {}, () => {
        ...
        QUnit.module('Focus', {}, () => {
            QUnit.test('Focused client should not receive step if no data channel is open', async (assert) => {
                ...
                await peers.p1.wysiwyg.manapathiEditor.execCommand('insert', 'b');
        ...
        QUnit.module('Stale detection & recovery', {}, () => {
            QUnit.module('detect stale while unfocused', async () => {
                QUnit.test('should do nothing until focus', async (assert) => {
                    ...
                    await peers.p1.wysiwyg.manapathiEditor.execCommand('insert', 'c');
        ...
        QUnit.module('Disconnect & reconnect', {}, () => {
            QUnit.test('should sync history when disconnecting and reconnecting to internet', async (assert) => {
                ...
                const setSelection = peer => {
                    ...
                    const pElement = peer.wysiwyg.manapathiEditor.editable.querySelector('p')
                ...
                const addP = (peer, content) => {
                    ...
                    peer.wysiwyg.manapathiEditor.editable.append(p);
                    peer.wysiwyg.manapathiEditor.historyStep();
                }
                ...
                await peers.p2.wysiwyg.manapathiEditor.execCommand('insert', 'e');
                addP(peers.p2, 'f');
