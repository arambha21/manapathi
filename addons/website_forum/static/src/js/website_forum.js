/** @manapathi-module **/
import { Component, useState, markup, onWillStart } from "@manapathi/owl";
...
publicWidget.registry.websiteForum = publicWidget.Widget.extend({
    ...
    async start() {
        ...
        var forumLogin = `${window.location.origin}/manapathi?redirect=${encodeURIComponent(window.location.href)}`
