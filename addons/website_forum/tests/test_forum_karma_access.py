...
from manapathi.addons.website_forum.tests.common import KARMA, TestForumCommon
from manapathi.exceptions import UserError, AccessError
...
class TestForumCRUD(TestForumCommon):
    ...
    def test_crud_rights(self):
        ...
        with mute_logger('manapathi.sql_db'):
...
class TestForumKarma(TestForumCommon):
    ...
    @mute_logger('manapathi.addons.base.models.ir_model', 'manapathi.models')
