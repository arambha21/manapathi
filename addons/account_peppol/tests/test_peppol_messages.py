...
from manapathi.tests.common import tagged, freeze_time
...
class TestPeppolMessage(TestAccountMoveSendCommon):
    ...
    @patch('manapathi.addons.account_peppol.models.res_partner.ResPartner._check_document_type_support', return_value=False)
