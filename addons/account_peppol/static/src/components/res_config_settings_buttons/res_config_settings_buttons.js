...
import { Component, markup, useState } from "@manapathi/owl";
...
class PeppolSettingsButtons extends Component {
    ...
    showConfirmation(warning, methodName) {
        ...
        const confirmMessage = _t("You will not be able to send or receive Peppol documents in Manapathi anymore. Are you sure you want to proceed?");
