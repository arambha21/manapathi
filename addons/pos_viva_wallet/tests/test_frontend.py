...
from manapathi.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon
from manapathi.addons.pos_viva_wallet.models.pos_payment_method import PosPaymentMethod
