...
from manapathi import Command, tools
from manapathi.addons.mail_group.tests.data import GROUP_TEMPLATE
from manapathi.addons.mail_group.tests.common import TestMailListCommon
from manapathi.exceptions import AccessError
from manapathi.tests.common import tagged, users
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('manapathi.models.unlink', 'manapathi.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('manapathi.addons.base.models.ir_rule', 'manapathi.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('manapathi.addons.mail.models.mail_thread', 'manapathi.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('manapathi.addons.mail.models.mail_thread', 'manapathi.addons.mail_group.models.mail_group_message', 'manapathi.models.unlink')
    @users('employee')
    ...
    @mute_logger('manapathi.addons.mail_group.models.mail_group')
    @users('employee')
