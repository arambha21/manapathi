...
from manapathi.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from manapathi.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("manapathi.addons.base.models.ir_http")
    ...
    @mute_logger('manapathi.addons.base.models.ir_http', 'manapathi.addons.sms.controllers.main', 'manapathi.http')
