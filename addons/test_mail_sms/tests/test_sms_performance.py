...
from manapathi.addons.sms.tests import common as sms_common
from manapathi.addons.test_mail.tests.test_performance import BaseMailPerformance
from manapathi.tests.common import users, warmup
...
class TestSMSPerformance(BaseMailPerformance, sms_common.SMSCase):
    ...
    @mute_logger('manapathi.addons.sms.models.sms_sms')
    @users('employee')
    @warmup
