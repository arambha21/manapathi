...
from manapathi.addons.base.tests.common import BaseCommon
...
class PaymentCommon(BaseCommon):
    ...
    def setUp(self):
        ...
        if self.account_payment_installed and self.enable_post_process_patcher:
            ...
            self.post_process_patcher = patch(
                'manapathi.addons.account_payment.models.payment_transaction.PaymentTransaction._post_process',
            )
    ...
    def _generate_test_access_token(self, *values):
        ...
        environment of manapathi.http.request.
