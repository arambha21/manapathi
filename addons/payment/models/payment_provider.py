...
from manapathi.addons.payment.const import REPORT_REASONS_MAPPING
...
class PaymentProvider(models.Model):
    ...
    capture_manually = fields.Boolean(
        ...
        help="Capture the amount from Manapathi, when the delivery is completed.\n"
    ...
    support_refund = fields.Selection(
        string="Refund",
        help="Refund is a feature allowing to refund customers directly from the payment in Manapathi.",
        selection=[
            ('none', "Unsupported"),
            ('full_only', "Full Only"),
    ...
    module_to_buy = fields.Boolean(string="Manapathi Enterprise Module", related='module_id.to_buy')
