...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('odoo', 'Manapathi'), ('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the Manapathi reference.")
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of Manapathi.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of Manapathi.\n"
        "Check: Pay bills by check and print it from Manapathi.\n"
    ...
    alias_id = fields.Many2one(help="Send one separate email for each invoice.\n\n"
                                    ...
                                    "Only PDF and XML files will be interpreted by Manapathi")
