...
from manapathi.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from manapathi.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'manapathi.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
