# Part of Manapathi. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.manapathi.com/documentation/master/applications/finance/fiscal_localizations/france.html',
    'icon': '/account/static/description/l10n.png',
    'countries': ['fr'],
    'version': '2.2',
    'category': 'Accounting/Localizations/Account Charts',
    'description': """
This is the module to manage the accounting chart for France in Manapathi.
========================================================================
