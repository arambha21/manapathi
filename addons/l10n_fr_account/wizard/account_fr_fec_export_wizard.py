...
import csv
import io
from manapathi.tools import float_is_zero, SQL
from manapathi import fields, models, api
from manapathi.tools.misc import get_lang
...
class FecExportWizard(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # 1) the XSD file impose to have the label on the account.move, but Manapathi has the label on the account.move.line,
        # so that's a  problem !
