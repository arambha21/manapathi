...
from manapathi.tools import DEFAULT_SERVER_DATETIME_FORMAT, get_lang
from manapathi.tools.float_utils import float_compare, float_round
...
class PurchaseOrderLine(models.Model):
    ...
    def _get_product_catalog_lines_data(self, **kwargs):
        ...
        :raise manapathi.exceptions.ValueError: ``len(self.product_id) != 1``
        :rtype: dict
