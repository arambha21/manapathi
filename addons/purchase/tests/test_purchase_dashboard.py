...
from manapathi.addons.mail.tests.common import MailCase
from manapathi.tests import tagged, Form, new_test_user
from manapathi.tools import mute_logger, format_amount
...
class TestPurchaseDashboard(AccountTestInvoicingCommon, MailCase):
    ...
    @mute_logger('manapathi.addons.mail.models.mail_mail')
