...
from manapathi.addons.website_event_sale.tests.common import TestWebsiteEventSaleCommon
from manapathi.addons.base.tests.common import HttpCaseWithUserPortal
...
class TestWebsiteEventBoothSale(HttpCaseWithUserPortal, TestWebsiteEventSaleCommon):
    ...
    def test_booth_pricelists_different_currencies(self):
        ...
        self.start_tour("/manapathi", 'event_booth_sale_pricelists_different_currencies', login='admin')
