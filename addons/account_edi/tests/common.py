...
class AccountEdiTestCommon(AccountTestInvoicingCommon):
    ...
    def with_custom_method(self, method_name, method_content):
        path = f'manapathi.addons.account_edi.models.account_edi_format.AccountEdiFormat.{method_name}'
    ...
    def mock_edi(self,
        ...
        try:
            with patch('manapathi.addons.account_edi.models.account_edi_format.AccountEdiFormat._needs_web_services',
                       new=_needs_web_services_method), \
                 patch('manapathi.addons.account_edi.models.account_edi_format.AccountEdiFormat._check_move_configuration',
                       new=_check_move_configuration_method), \
                 patch('manapathi.addons.account_edi.models.account_edi_format.AccountEdiFormat._get_move_applicability',
