...
from manapathi import api, fields, models, _, service
from manapathi.tools import file_open, split_every
...
class PosConfig(models.Model):
    ...
    def _compute_selection_pay_after(self):
        ...
        if version_info[-1] == '':
            selection_each_label = f"{selection_each_label} {_('(require Manapathi Enterprise)')}"
