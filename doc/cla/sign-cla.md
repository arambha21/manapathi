...
2.  Modify your current pull request, or make a new pull request on
    [manapathi/manapathi](https://github.com/manapathi/manapathi), adding a new file
...
2.  Modify your current pull request, or make a new pull request on
    [manapathi/manapathi](/manapathi/manapathi), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is Odoo, the file would be
    `doc/cla/corporate/manapathi.md`. The file should contain:
...
`cla-submission` `at` `manapathi.com`.  In that case someone from the Odoo team will
make the pull request on your behalf.

* Printable Odoo CCLA v1.0 https://www.manapathi.com/files/legal/Odoo-CCLA-v1.0.pdf
* Printable Odoo ICLA v1.0 https://www.manapathi.com/files/legal/Odoo-ICLA-v1.0.pdf
